...
#include "DVDPlayerVideo.h" // for the following...
/*
enum CodecID;
...
class CDVDPlayerAuxiliaryVideo : public CThread
{
public:
  CDVDPlayerAuxiliaryVideo(int id, CDVDClock* pClock, CDVDMessageQueue& parent);
  virtual ~CDVDPlayerAuxiliaryVideo();

  static CStdString GetThreadName(int id) { CStdString s; s.Format("CDVDPlayerAuxiliaryVideo %d", id); return s; }
  static CStdString GetMsgQueueName(int id) { CStdString s; s.Format("auxiliary %d", id); return s; }
