...
namespace PYXBMC
{
  ...
  InitGUITypes(void)
  {
    ...
    if (PyType_Ready(&Window_Type) < 0 ||
        ...
        PyType_Ready(&ControlPanel_Type) < 0 ||
  ...
  InitGUIModule(void)
  {
    ...
    PyModule_AddObject(pXbmcGuiModule, (char*)"ControlPanel", (PyObject*)&ControlPanel_Type);
