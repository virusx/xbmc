...
#include "guilib/GUIListContainer.h" // Remove me!!!
...
namespace PYXBMC
{
  ...
  PyObject* ControlPanel_New(PyTypeObject *type, PyObject *args, PyObject *kwds)
  {
    ...
    self = (ControlPanel*)type->tp_alloc(type, 0);
    if (!self) return NULL;
  ...
  void ControlPanel_Dealloc(ControlPanel* self)
  {
  ...
  CGUIControl* ControlPanel_Create(ControlPanel* pControl)
  {
    CLabelInfo label;
...
PyDoc_STRVAR(addItem__doc__,
    "addItem(item) -- Add a new item to this panel control.\n"
    "\n"
    "item               : string, unicode or ListItem - item to add.\n"
    "\n"
    "example:\n"
    "  - cPanel.addItem('Reboot XBMC')\n");

  PyObject* ControlPanel_AddItem(ControlPanel *self, PyObject *args)
  {
    PyObject *pObject;
...
PyDoc_STRVAR(addItems__doc__,
    "addItems(items) -- Adds a list of listitems or strings to this panel control.\n"
    "\n"
    "items                : List - list of strings, unicode objects or ListItems to add.\n"
    "\n"
    "*Note, You can use the above as keywords for arguments.\n"
    "\n"
    "       Adding a large list is considerably better than using the standard addItem()"
    "\n"
    "example:\n"
    "  - cPanel.addItems(items=listitems)\n");

  PyObject* ControlPanel_AddItems(ControlPanel *self, PyObject *args, PyObject *kwds)
  {
    PyObject *pList = NULL;
  ...
  /*
  * ControlPanel_SelectItem(int item)
  ...
  */
  PyDoc_STRVAR(selectItem,
    ...
    "\n"
    "example:\n"
    "  - cPanel.selectItem(12)\n");

  PyObject* ControlPanel_SelectItem(ControlPanel *self, PyObject *args)
  {
    long itemIndex;
  ...
  PyDoc_STRVAR(reset__doc__,
    "reset() -- Clear all ListItems in this control panel.\n"
    "\n"
    "example:\n"
    "  - cPanel.reset()\n");

  PyObject* ControlPanel_Reset(ControlPanel *self, PyObject *args)
  {
    // create message
    ControlPanel *pControl = (ControlPanel*)self;
  ...
  PyDoc_STRVAR(getSpinControl__doc__,
    ...
    "       After adding this control panel to a window it is not possible to change\n"
    "       the settings of this spin control.\n"
    "\n"
    "example:\n"
    "  - ctl = cPanel.getSpinControl()\n");

  PyObject* ControlPanel_GetSpinControl(ControlPanel *self, PyObject *args)
  {
  ...
  PyDoc_STRVAR(setImageDimensions__doc__,
    ...
    "\n"
    "example:\n"
    "  - cPanel.setImageDimensions(18, 18)\n");

  PyObject* ControlPanel_SetImageDimensions(ControlPanel *self, PyObject *args)
  {
  ...
  PyDoc_STRVAR(setItemHeight__doc__,
    ...
    "\n"
    "example:\n"
    "  - cPanel.setItemHeight(25)\n");

  PyObject* ControlPanel_SetItemHeight(ControlPanel *self, PyObject *args)
  {
  ...
  PyDoc_STRVAR(setPageControlVisible__doc__,
    ...
    "\n"
    "example:\n"
    "  - cPanel.setPageControlVisible(True)\n");

  PyObject* ControlPanel_SetPageControlVisible(ControlPanel *self, PyObject *args)
  {
    char isOn = true;
  ...
  PyObject* ControlPanel_SetSpace(ControlPanel *self, PyObject *args)
  {
  ...
  PyDoc_STRVAR(getSelectedItem__doc__,
    ...
    "       is returned. Returns None for empty panels.\n"
    "       See windowexample.py on how to use this.\n"
    "\n"
    "example:\n"
    "  - item = cPanel.getSelectedItem()\n");

  PyObject* ControlPanel_GetSelectedItem(ControlPanel *self, PyObject *args)
  {
    // create message
    ControlPanel *pControl = (ControlPanel*)self;
    CGUIMessage msg(GUI_MSG_ITEM_SELECTED, pControl->iParentId, pControl->iControlId);
  ...
  PyObject* ControlPanel_Size(ControlPanel *self)
  {
  ...
  PyDoc_STRVAR(getListItem__doc__,
    "getListItem(index) -- Returns a given ListItem in this panel.\n"
    "\n"
    ...
    "\n"
    "example:\n"
    "  - listitem = cPanel.getListItem(6)\n");

  PyObject* ControlPanel_GetListItem(ControlPanel *self, PyObject *args)
  {
    int iPos = -1;
  ...
  PyDoc_STRVAR(getItemHeight__doc__,
    ...
    "\n"
    "example:\n"
    "  - item_height = self.cPanel.getItemHeight()\n");

  PyObject* ControlPanel_GetItemHeight(ControlPanel *self)
  {
  ...
  PyDoc_STRVAR(getSpace__doc__,
    ...
    "\n"
    "example:\n"
    "  - gap = self.cPanel.getSpace()\n");

  PyObject* ControlPanel_GetSpace(ControlPanel *self)
  {
    return Py_BuildValue((char*)"l", self->space);
  }

PyDoc_STRVAR(setStaticContent__doc__,
    "setStaticContent(items) -- Fills a static panel with a list of listitems.\n"
    "\n"
    ...
    "\n"
    "example:\n"
    "  - cPanel.setStaticContent(items=listitems)\n");

  PyObject* ControlPanel_SetStaticContent(ControlPanel *self, PyObject *args, PyObject *kwds)
  {
    PyObject *pList = NULL;
    static const char *keywords[] = { "items", NULL };
  ...
  PyMethodDef ControlList_methods[] = {
    {(char*)"addItem", (PyCFunction)ControlPanel_AddItem, METH_VARARGS, addItem__doc__},
    {(char*)"selectItem", (PyCFunction)ControlPanel_SelectItem, METH_VARARGS,  selectItem},
    {(char*)"reset", (PyCFunction)ControlPanel_Reset, METH_VARARGS, reset__doc__},
    {(char*)"getSpinControl", (PyCFunction)ControlPanel_GetSpinControl, METH_VARARGS, getSpinControl__doc__},
    {(char*)"getSelectedPosition", (PyCFunction)ControlPanel_GetSelectedPosition, METH_VARARGS, getSelectedPosition__doc__},
    {(char*)"getSelectedItem", (PyCFunction)ControlPanel_GetSelectedItem, METH_VARARGS, getSelectedItem__doc__},
    {(char*)"setImageDimensions", (PyCFunction)ControlPanel_SetImageDimensions, METH_VARARGS, setImageDimensions__doc__},
    {(char*)"setItemHeight", (PyCFunction)ControlPanel_SetItemHeight, METH_VARARGS, setItemHeight__doc__},
    {(char*)"setSpace", (PyCFunction)ControlPanel_SetSpace, METH_VARARGS, setSpace__doc__},
    {(char*)"setPageControlVisible", (PyCFunction)ControlPanel_SetPageControlVisible, METH_VARARGS, setPageControlVisible__doc__},
    {(char*)"size", (PyCFunction)ControlPanel_Size, METH_VARARGS, size__doc__},
    {(char*)"getItemHeight", (PyCFunction)ControlPanel_GetItemHeight, METH_VARARGS, getItemHeight__doc__},
    {(char*)"getSpace", (PyCFunction)ControlPanel_GetSpace, METH_VARARGS, getSpace__doc__},
    {(char*)"getListItem", (PyCFunction)ControlPanel_GetListItem, METH_VARARGS, getListItem__doc__},
    {(char*)"setStaticContent", (PyCFunction)ControlPanel_SetStaticContent, METH_VARARGS|METH_KEYWORDS, setStaticContent__doc__},
    {(char*)"addItems", (PyCFunction)ControlPanel_AddItems, METH_VARARGS|METH_KEYWORDS, addItems__doc__},
    {NULL, NULL, 0, NULL}
  };

  PyDoc_STRVAR(controlPanel__doc__,
    "ControlPanel class.\n"
    "\n"
    "ControlPanel(x, y, width, height[, font, textColor, buttonTexture, buttonFocusTexture,\n"
    ...
    "\n"
    "example:\n"
    "  - self.cPanel = xbmcgui.ControlPanel(100, 250, 200, 250, 'font14', space=5)\n"
  );

// Restore code and data sections to normal.

  PyTypeObject ControlPanel_Type;

  void initControlPanel_Type()
  {
    PyXBMCInitializeTypeObject(&ControlPanel_Type);

    ControlPanel_Type.tp_name = (char*)"xbmcgui.ControlPanel";
    ControlPanel_Type.tp_basicsize = sizeof(ControlPanel);
    ControlPanel_Type.tp_dealloc = (destructor)ControlPanel_Dealloc;
    ControlPanel_Type.tp_compare = 0;
    ControlPanel_Type.tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE;
    ControlPanel_Type.tp_doc = controlPanel__doc__;
    ControlPanel_Type.tp_methods = ControlPanel_methods;
    ControlPanel_Type.tp_base = &Control_Type;
    ControlPanel_Type.tp_new = ControlPanel_New;
  }
}
