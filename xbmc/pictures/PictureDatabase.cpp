...
CFileItem* CPictureDatabase::CreateFileItemJSON(const string &strJson, int id) const
{
  CPictureInfoTag p;
  DeserializeJSON(strJson, id, &p);
...
CFileItem* CPictureDatabase::CreateFileItemBSON(const string &strBson, int id) const
{
  CPictureInfoTag p;
